...
const AIRPORTS = [
  ...
  },
  {
    ...
    name: '鲲鹏加速',
    emoji: '🦅',
    description: '1元试用极低试错成本，全站1.0倍率无暗扣，中转线路，流媒体全解锁',
    tags: ['value', 'stable', 'fast'],
    tagLabels: ['一元套餐', '高性价比', '稳定'],
    baseSpeed: 158,
    baseLatency: 80,
    uptime: 99.8,
    price: '¥12/月',
    link: 'https://kunpengjiasu.com/#/register?code=tQvtkYsB',
    discount: '1元尝鲜体验套餐，好用再升级',
    plans: [
      { name: '扶摇尝鲜', desc: '1GB 体验流量（一次性）', price: '¥1.00 / 永久' },
      { name: '逍遥畅游', desc: '99GB 流量 / 月（5台设备）', price: '¥12.00 / 月' },
      { name: '吞吐山海', desc: '199GB 流量 / 月（8台设备）', price: '¥22.00 / 月' },
    ],
    nodeCount: 15,
    protocols: ['VLESS', 'SS'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 3 },
      { flag: '🇯🇵', name: '日本', count: 3 },
      { flag: '🇹🇼', name: '台湾', count: 3 },
      { flag: '🇸🇬', name: '新加坡', count: 3 },
      { flag: '🇺🇸', name: '美国', count: 3 },
    ],
    nodes: generateNodes('kunpeng', 15),
  ...
  },
  {
    ...
    plans: [
      ...
      { name: '月付600G旺财版', desc: '600GB 高速流量 / 月', price: '¥16.00 / 月' },
      { name: '季付200G特惠', desc: '200GB 流量 / 月', price: '¥18.00 / 季' },
      { name: '年付400G特惠', desc: '400GB 流量 / 月', price: '¥99.00 / 年' },
      { name: '不限时300G鸿运版', desc: '300GB时间永久', price: '¥99.00 / 永久' }
    ],
    nodeCount: 85,
    protocols: ['VLESS'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 25 },
      { flag: '🇯🇵', name: '日本', count: 20 },
      { flag: '🇹🇼', name: '台湾', count: 15 },
      { flag: '🇸🇬', name: '新加坡', count: 15 },
      { flag: '🇺🇸', name: '美国', count: 10 },
    ],
    nodes: generateNodes('jiuyun', 85),
  ...
  },
  {
    ...
    name: '宝云机场',
    emoji: '💎',
    description: '海外中转线路，VLESS协议，支持ChatGPT/Gemini，晚高峰YouTube 4K流畅',
    tags: ['value', 'stable', 'fast'],
    tagLabels: ['性价比', '稳定', '极速'],
    baseSpeed: 148,
    baseLatency: 22,
    uptime: 99.8,
    price: '¥4/月',
    link: 'https://888by.baoyundl.com/#/register?code=089ta958',
    discount: '',
    plans: [
      { name: '福宝', desc: '200G 流量 / 月', price: '¥4.00 / 月' },
      { name: '财宝', desc: '500G 流量 / 月', price: '¥8.00 / 月' },
      { name: '金宝', desc: '1000G 流量 / 月', price: '¥13.00 / 月' },
      { name: '传家宝', desc: '100G 一次性流量', price: '¥29.00 / 永久' },
      { name: '传世宝', desc: '500G 一次性流量', price: '¥39.00 / 永久' },
      { name: '传承宝', desc: '1000G 一次性流量', price: '¥59.00 / 永久' },
      { name: '季付特惠', desc: '500G 流量 / 月', price: '¥19.00 / 季' }
    ],
    nodeCount: 145,
    protocols: ['VLESS'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 42 },
      { flag: '🇯🇵', name: '日本', count: 35 },
      { flag: '🇹🇼', name: '台湾', count: 28 },
      { flag: '🇸🇬', name: '新加坡', count: 24 },
      { flag: '🇺🇸', name: '美国', count: 16 },
    ],
    nodes: generateNodes('baoyun', 145),
  ...
  // airport14-23: 新增机场
  {
    ...
    name: '魔法云',
    emoji: '🪄',
    description: '专线机场，限时优惠，142 MB/s高速，¥20/月起',
    tags: ['fast', 'stable'],
    tagLabels: ['专线机场', '限时优惠'],
    baseSpeed: 128,
    baseLatency: 20,
    uptime: 99.8,
    price: '¥20/月',
    reviewUrl: 'airport14-jichang-pingce.html',
    nodeCount: 150,
    protocols: ['Trojan', 'VLESS', 'Shadowsocks'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 45 },
      { flag: '🇯🇵', name: '日本', count: 37 },
      { flag: '🇸🇬', name: '新加坡', count: 30 },
      { flag: '🇺🇸', name: '美国', count: 22 },
      { flag: '🌍', name: '其他', count: 16 },
    ],
    nodes: generateNodes('mofayun', 150),
  ...
  },
  {
    ...
    name: '速鹰机场',
    emoji: '🦅',
    description: '老牌机场，已运营3年，138 MB/s，¥22/月起',
    tags: ['fast', 'stable'],
    tagLabels: ['老牌机场', '已运营3年'],
    baseSpeed: 128,
    baseLatency: 22,
    uptime: 99.7,
    price: '¥22/月',
    reviewUrl: 'airport15-jichang-pingce.html',
    nodeCount: 160,
    protocols: ['Trojan', 'Vmess', 'VLESS'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 48 },
      { flag: '🇯🇵', name: '日本', count: 40 },
      { flag: '🇸🇬', name: '新加坡', count: 32 },
      { flag: '🇺🇸', name: '美国', count: 24 },
      { flag: '🌍', name: '其他', count: 16 },
    ],
    nodes: generateNodes('suyingjichang', 160),
  ...
  },
  {
    ...
    name: '飞鱼机场',
    emoji: '🐟',
    description: '高性价比，入门首选，125 MB/s，¥18/月起',
    ...
    uptime: 99.6,
    price: '¥18/月',
    reviewUrl: 'airport16-jichang-pingce.html',
    nodeCount: 120,
    protocols: ['Shadowsocks', 'Trojan'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 36 },
      { flag: '🇯🇵', name: '日本', count: 30 },
      { flag: '🇸🇬', name: '新加坡', count: 24 },
      { flag: '🇺🇸', name: '美国', count: 18 },
      { flag: '🌍', name: '其他', count: 12 },
    ],
    nodes: generateNodes('feiyujichang', 120),
  ...
  },
  {
    ...
    name: '龙猫云',
    emoji: '🐱',
    description: '轻量机场，学生首选，¥15/月超低价起',
    tags: ['value', 'affordable'],
    tagLabels: ['轻量机场', '学生首选'],
    baseSpeed: 118,
    baseLatency: 32,
    uptime: 99.5,
    price: '¥15/月',
    reviewUrl: 'airport17-jichang-pingce.html',
    nodeCount: 100,
    protocols: ['Shadowsocks', 'V2Ray'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 30 },
      { flag: '🇯🇵', name: '日本', count: 25 },
      { flag: '🇸🇬', name: '新加坡', count: 20 },
      { flag: '🇺🇸', name: '美国', count: 15 },
      { flag: '🌍', name: '其他', count: 10 },
    ],
    nodes: generateNodes('longmaoyun', 100),
    color: 'linear-gradient(135deg, #10b981, #059669)',
  },
  {
    id: 'jiguangyun',
    name: '极光云',
    emoji: '🌈',
    description: '流媒体专家，Netflix原生解锁，135 MB/s，¥28/月',
    tags: ['fast', 'stable'],
    tagLabels: ['流媒体专家', 'Netflix原生'],
    baseSpeed: 128,
    baseLatency: 24,
    uptime: 99.8,
    price: '¥28/月',
    reviewUrl: 'airport18-jichang-pingce.html',
    nodeCount: 170,
    protocols: ['Trojan', 'VLESS', 'Shadowsocks'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 51 },
      { flag: '🇯🇵', name: '日本', count: 42 },
      { flag: '🇸🇬', name: '新加坡', count: 34 },
      { flag: '🇺🇸', name: '美国', count: 25 },
      { flag: '🌍', name: '其他', count: 18 },
    ],
    nodes: generateNodes('jiguangyun', 170),
  ...
  },
  {
    ...
    name: '速云',
    emoji: '💨',
    description: '大厂技术团队，企业级稳定，145 MB/s，¥35/月',
    tags: ['fast', 'stable', 'pro'],
    tagLabels: ['企业级稳定', '大厂技术'],
    baseSpeed: 130,
    baseLatency: 18,
    uptime: 99.9,
    price: '¥35/月',
    reviewUrl: 'airport19-jichang-pingce.html',
    nodeCount: 200,
    protocols: ['VLESS', 'Reality', 'Trojan'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 60 },
      { flag: '🇯🇵', name: '日本', count: 50 },
      { flag: '🇸🇬', name: '新加坡', count: 40 },
      { flag: '🇺🇸', name: '美国', count: 30 },
      { flag: '🌍', name: '其他', count: 20 },
    ],
    nodes: generateNodes('suyun', 200),
  ...
  },
  {
    ...
    name: '翼云',
    emoji: '🦋',
    description: '高性价比中档之选，122 MB/s，¥20/月起',
    tags: ['value', 'affordable'],
    tagLabels: ['高性价比', '中档之选'],
    baseSpeed: 122,
    baseLatency: 30,
    uptime: 99.5,
    price: '¥20/月',
    reviewUrl: 'airport20-jichang-pingce.html',
    nodeCount: 130,
    protocols: ['Trojan', 'Shadowsocks', 'V2Ray'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 38 },
      { flag: '🇯🇵', name: '日本', count: 32 },
      { flag: '🇸🇬', name: '新加坡', count: 26 },
      { flag: '🇺🇸', name: '美国', count: 20 },
      { flag: '🌍', name: '其他', count: 14 },
    ],
    nodes: generateNodes('yiyun', 130),
    color: 'linear-gradient(135deg, #f59e0b, #f97316)',
  },
  // 新增机场：秒秒云/山水云/锦云/鲤云/财路云（排名第7-11位）
  {
    id: 'miaomiaoyun',
    name: '秒秒云',
    emoji: '⏱️',
    description: '海外中转VLESS协议，套餐灵活多样，128G仅¥14/月起，入门高性价比',
    tags: ['value', 'newbie'],
    tagLabels: ['性价比', '入门友好'],
    baseSpeed: 130,
    baseLatency: 26,
    uptime: 99.6,
    price: '¥14/月',
    link: 'https://m2.mouhiojl.com:8888/#/register?code=6u2dHtD4',
    plans: [
      { name: '月付128G', desc: '128GB 流量 / 月', price: '¥14.00 / 月' },
      { name: '月付256G', desc: '256GB 流量 / 月', price: '¥26.00 / 月' },
      { name: '月付512G', desc: '512GB 流量 / 月', price: '¥49.00 / 月' },
      { name: '不限时100G', desc: '100GB 不限时', price: '¥150.00 / 次' },
    ],
    nodeCount: 95,
    protocols: ['VLESS'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 28 },
      { flag: '🇯🇵', name: '日本', count: 24 },
      { flag: '🇸🇬', name: '新加坡', count: 20 },
      { flag: '🇺🇸', name: '美国', count: 15 },
      { flag: '🌍', name: '其他', count: 8 },
    ],
    nodes: generateNodes('miaomiaoyun', 95),
  ...
  },
  {
    ...
    name: '山水云',
    emoji: '🏞️',
    description: '优质中转线路，独家不限时套餐设计，100G仅¥15/月起，灵活按需付费',
    tags: ['value', 'stable'],
    tagLabels: ['不限时套餐', '稳定'],
    baseSpeed: 130,
    baseLatency: 24,
    uptime: 99.6,
    price: '¥15/月',
    link: 'https://sldm1.ssyylf.com/#/register?code=4WTXbMwy',
    plans: [
      { name: '月付100G', desc: '100GB 流量 / 月', price: '¥15.00 / 月' },
      { name: '月付200G', desc: '200GB 流量 / 月', price: '¥25.00 / 月' },
      { name: '月付500G', desc: '500GB 流量 / 月', price: '¥50.00 / 月' },
      { name: '不限时100G', desc: '100GB 不限时', price: '¥150.00 / 次' },
    ],
    nodeCount: 110,
    protocols: ['Trojan', 'VLESS', 'Shadowsocks'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 32 },
      { flag: '🇯🇵', name: '日本', count: 27 },
      { flag: '🇹🇼', name: '台湾', count: 22 },
      { flag: '🇸🇬', name: '新加坡', count: 18 },
      { flag: '🇺🇸', name: '美国', count: 11 },
    ],
    nodes: generateNodes('shanshuiyun', 110),
  ...
  },
  {
    ...
    name: '锦云',
    emoji: '🔷',
    description: '小流量超低价专家，50G仅¥6/月，市面最便宜机场之一，入门首选',
    tags: ['value', 'budget'],
    tagLabels: ['超低价', '小流量专家'],
    baseSpeed: 130,
    baseLatency: 30,
    uptime: 99.4,
    price: '¥6/月',
    link: 'https://jybdw1.wanhlj.com:8888/#/register?code=0xeLRRWB',
    plans: [
      { name: '月付50G', desc: '50GB 流量 / 月', price: '¥6.00 / 月' },
      { name: '月付100G', desc: '100GB 流量 / 月', price: '¥9.00 / 月' },
      { name: '月付200G', desc: '200GB 流量 / 月', price: '¥16.00 / 月' },
    ],
    nodeCount: 70,
    protocols: ['Shadowsocks', 'VLESS'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 21 },
      { flag: '🇯🇵', name: '日本', count: 18 },
      { flag: '🇸🇬', name: '新加坡', count: 15 },
      { flag: '🇺🇸', name: '美国', count: 10 },
      { flag: '🌍', name: '其他', count: 6 },
    ],
    nodes: generateNodes('jinyun', 70),
  ...
  },
  {
    ...
    name: '鲤云',
    emoji: '🐟',
    description: '套餐覆盖50G至8200G超大流量，性价比极高，轻中重度用户皆宜',
    tags: ['value', 'stable'],
    tagLabels: ['套餐丰富', '性价比'],
    baseSpeed: 130,
    baseLatency: 28,
    uptime: 99.5,
    price: '¥7/月',
    link: 'https://ly888.liydl.com:8888/#/register?code=ihbhLNee',
    plans: [
      { name: '月付50G', desc: '50GB 流量 / 月', price: '¥7.00 / 月' },
      { name: '月付100G', desc: '100GB 流量 / 月', price: '¥10.00 / 月' },
      { name: '超大流量8200G', desc: '8200GB 流量 / 月', price: '¥17.00 / 月' },
    ],
    nodeCount: 90,
    protocols: ['VLESS', 'Trojan'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 27 },
      { flag: '🇯🇵', name: '日本', count: 23 },
      { flag: '🇸🇬', name: '新加坡', count: 18 },
      { flag: '🇺🇸', name: '美国', count: 14 },
      { flag: '🌍', name: '其他', count: 8 },
    ],
    nodes: generateNodes('liyun', 90),
  ...
  },
  {
    ...
    name: '财路云',
    emoji: '💰',
    description: '小流量灵活套餐，按需计费，50G仅¥7/月，轻度用户高性价比之选',
    tags: ['value', 'budget'],
    tagLabels: ['灵活计费', '性价比'],
    baseSpeed: 130,
    baseLatency: 29,
    uptime: 99.5,
    price: '¥7/月',
    link: 'https://cl888.cailudl.com:9999/#/register?code=d4UTPba8',
    plans: [
      { name: '月付50G', desc: '50GB 流量 / 月', price: '¥7.00 / 月' },
      { name: '月付100G', desc: '100GB 流量 / 月', price: '¥14.00 / 月' },
      { name: '月付200G', desc: '200GB 流量 / 月', price: '¥28.00 / 月' },
    ],
    nodeCount: 75,
    protocols: ['Shadowsocks', 'Trojan'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 22 },
      { flag: '🇯🇵', name: '日本', count: 19 },
      { flag: '🇸🇬', name: '新加坡', count: 16 },
      { flag: '🇺🇸', name: '美国', count: 11 },
      { flag: '🌍', name: '其他', count: 7 },
    ],
    nodes: generateNodes('cailuyun', 75),
  ...
  },
  {
    ...
    name: '彩虹云',
    emoji: '🌊',
    description: '流媒体全解锁首选，Netflix原生，130 MB/s，¥25/月',
    tags: ['fast', 'stable'],
    tagLabels: ['流媒体全解锁', 'Netflix原生'],
    baseSpeed: 130,
    baseLatency: 26,
    uptime: 99.6,
    price: '¥25/月',
    reviewUrl: 'airport21-jichang-pingce.html',
    nodeCount: 145,
    protocols: ['Trojan', 'VLESS', 'Shadowsocks'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 44 },
      { flag: '🇯🇵', name: '日本', count: 36 },
      { flag: '🇸🇬', name: '新加坡', count: 29 },
      { flag: '🇺🇸', name: '美国', count: 22 },
      { flag: '🌍', name: '其他', count: 14 },
    ],
    nodes: generateNodes('caihongyun', 145),
  ...
  },
  {
    ...
    name: '迅风云',
    emoji: '🌪️',
    description: '速度全榜最快，152 MB/s，16ms超低延迟，¥42/月',
    tags: ['fast', 'pro'],
    tagLabels: ['速度全榜最快', '旗舰级'],
    baseSpeed: 130,
    baseLatency: 16,
    uptime: 99.9,
    price: '¥42/月',
    reviewUrl: 'airport22-jichang-pingce.html',
    nodeCount: 220,
    protocols: ['VLESS', 'Reality', 'Trojan'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 66 },
      { flag: '🇯🇵', name: '日本', count: 55 },
      { flag: '🇸🇬', name: '新加坡', count: 44 },
      { flag: '🇺🇸', name: '美国', count: 33 },
      { flag: '🌍', name: '其他', count: 22 },
    ],
    nodes: generateNodes('xunfengyun', 220),
  ...
  },
  {
    ...
    name: '银河云',
    emoji: '🌌',
    description: '均衡全能型机场，各项指标无短板，128 MB/s，¥23/月',
    tags: ['stable', 'value'],
    tagLabels: ['均衡全能', '综合推荐'],
    baseSpeed: 128,
    baseLatency: 28,
    uptime: 99.7,
    price: '¥23/月',
    reviewUrl: 'airport23-jichang-pingce.html',
    nodeCount: 155,
    protocols: ['Trojan', 'VLESS', 'Shadowsocks'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 47 },
      { flag: '🇯🇵', name: '日本', count: 38 },
      { flag: '🇸🇬', name: '新加坡', count: 31 },
      { flag: '🇺🇸', name: '美国', count: 23 },
      { flag: '🌍', name: '其他', count: 16 },
    ],
    nodes: generateNodes('yingheyun', 155),
    color: 'linear-gradient(135deg, #6366f1, #0ea5e9)',
  },
  {
    id: 'xingchenyun',
    name: '星辰云',
    emoji: '⭐',
    description: '稳定IEPL专线，高性价比之选，133 MB/s，¥24/月',
    tags: ['value', 'stable'],
    tagLabels: ['高性价比', '稳定专线'],
    baseSpeed: 130,
    baseLatency: 25,
    uptime: 99.6,
    price: '¥24/月',
    reviewUrl: 'airport24-jichang-pingce.html',
    nodeCount: 155,
    protocols: ['Trojan', 'VLESS', 'Shadowsocks'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 46 },
      { flag: '🇯🇵', name: '日本', count: 39 },
      { flag: '🇸🇬', name: '新加坡', count: 31 },
      { flag: '🇺🇸', name: '美国', count: 25 },
      { flag: '🌍', name: '其他', count: 14 },
    ],
    nodes: generateNodes('xingchenyun', 155),
    color: 'linear-gradient(135deg, #f59e0b, #d97706)',
  },
  {
    id: 'liefengyun',
    name: '烈风云',
    emoji: '🔥',
    description: 'IPLC高速专线，性能均衡全能选手，140 MB/s，¥30/月',
    tags: ['fast', 'stable'],
    tagLabels: ['高速专线', '均衡全能'],
    baseSpeed: 128,
    baseLatency: 21,
    uptime: 99.7,
    price: '¥30/月',
    reviewUrl: 'airport25-jichang-pingce.html',
    nodeCount: 175,
    protocols: ['Trojan', 'VLESS', 'Hysteria2'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 52 },
      { flag: '🇯🇵', name: '日本', count: 44 },
      { flag: '🇸🇬', name: '新加坡', count: 35 },
      { flag: '🇺🇸', name: '美国', count: 28 },
      { flag: '🌍', name: '其他', count: 16 },
    ],
    nodes: generateNodes('liefengyun', 175),
  ...
  },
  {
    ...
    name: '极北云',
    emoji: '🧊',
    description: '极致低价入门，¥16/月轻度用户首选，116 MB/s',
    tags: ['budget', 'value'],
    tagLabels: ['超低价', '入门首选'],
    baseSpeed: 116,
    baseLatency: 33,
    uptime: 99.4,
    price: '¥16/月',
    reviewUrl: 'airport26-jichang-pingce.html',
    nodeCount: 110,
    protocols: ['Shadowsocks', 'VLESS'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 33 },
      { flag: '🇯🇵', name: '日本', count: 28 },
      { flag: '🇸🇬', name: '新加坡', count: 22 },
      { flag: '🇺🇸', name: '美国', count: 17 },
      { flag: '🌍', name: '其他', count: 10 },
    ],
    nodes: generateNodes('jibeiyun', 110),
    color: 'linear-gradient(135deg, #0ea5e9, #0284c7)',
  },
  {
    id: 'yunhaijichang',
    name: '云海机场',
    emoji: '🌊',
    description: 'IEPL中速专线，均衡日常首选，127 MB/s，¥22/月',
    tags: ['stable', 'value'],
    tagLabels: ['均衡专线', '日常推荐'],
    baseSpeed: 127,
    baseLatency: 27,
    uptime: 99.5,
    price: '¥22/月',
    reviewUrl: 'airport27-jichang-pingce.html',
    nodeCount: 140,
    protocols: ['Trojan', 'VLESS', 'Shadowsocks'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 42 },
      { flag: '🇯🇵', name: '日本', count: 35 },
      { flag: '🇸🇬', name: '新加坡', count: 28 },
      { flag: '🇺🇸', name: '美国', count: 22 },
      { flag: '🌍', name: '其他', count: 13 },
    ],
    nodes: generateNodes('yunhaijichang', 140),
  ...
  },
  {
    ...
    name: '疾风云',
    emoji: '💨',
    description: '顶级IPLC全专线，148 MB/s极速，19ms超低延迟，¥38/月',
    tags: ['fast', 'premium'],
    tagLabels: ['顶级专线', '极速旗舰'],
    baseSpeed: 130,
    baseLatency: 19,
    uptime: 99.8,
    price: '¥38/月',
    reviewUrl: 'airport28-jichang-pingce.html',
    nodeCount: 190,
    protocols: ['Trojan', 'VLESS', 'Hysteria2', 'TUIC'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 57 },
      { flag: '🇯🇵', name: '日本', count: 48 },
      { flag: '🇸🇬', name: '新加坡', count: 38 },
      { flag: '🇺🇸', name: '美国', count: 29 },
      { flag: '🌍', name: '其他', count: 18 },
    ],
    nodes: generateNodes('jifengyun', 190),
  ...
  },
  {
    ...
    name: '光年云',
    emoji: '💫',
    description: 'BGP优化线路，¥20/月性价比均衡，124 MB/s',
    tags: ['value', 'budget'],
    tagLabels: ['高性价比', 'BGP优化'],
    baseSpeed: 124,
    baseLatency: 29,
    uptime: 99.5,
    price: '¥20/月',
    reviewUrl: 'airport29-jichang-pingce.html',
    nodeCount: 125,
    protocols: ['Shadowsocks', 'VLESS', 'Trojan'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 37 },
      { flag: '🇯🇵', name: '日本', count: 31 },
      { flag: '🇸🇬', name: '新加坡', count: 25 },
      { flag: '🇺🇸', name: '美国', count: 20 },
      { flag: '🌍', name: '其他', count: 12 },
    ],
    nodes: generateNodes('guangnianyun', 125),
    color: 'linear-gradient(135deg, #8b5cf6, #7c3aed)',
  },
  {
    id: 'anyingyun',
    name: '暗影云',
    emoji: '🌑',
    description: 'IPLC中速专线，高稳定性均衡旗舰，136 MB/s，¥26/月',
    tags: ['stable', 'fast'],
    tagLabels: ['高稳定', '均衡旗舰'],
    baseSpeed: 128,
    baseLatency: 23,
    uptime: 99.7,
    price: '¥26/月',
    reviewUrl: 'airport30-jichang-pingce.html',
    nodeCount: 165,
    protocols: ['Trojan', 'VLESS', 'Hysteria2'],
    regions: [
      { flag: '🇭🇰', name: '香港', count: 49 },
      { flag: '🇯🇵', name: '日本', count: 41 },
      { flag: '🇸🇬', name: '新加坡', count: 33 },
      { flag: '🇺🇸', name: '美国', count: 26 },
      { flag: '🌍', name: '其他', count: 16 },
    ],
    nodes: generateNodes('anyingyun', 165),
